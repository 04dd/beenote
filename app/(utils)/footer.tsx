...
export default function Footer() {
    ...
    <footer className="footer footer-center p-10 bg-primary text-primary-content">
      <div>
        <Logo size={50}/>
        <p className="font-bold">Built by <a href="https://github.com/04dd/beenote" target="_blank" rel="noreferrer"><u>04dd</u></a></p> 
      ...
      <div>
        <div className="grid grid-flow-col gap-4">
          ...
          <a title="GitHub Repo" href="https://github.com/04dd/beenote" target="_blank" rel="noreferrer">
